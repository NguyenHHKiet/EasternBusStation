...
public class AdminController {
	...
	@GetMapping
	public String displayDashboard(Model model, UserLoginDTO user) {
...
//	}
	...
	@PostMapping
	public String saveBusData(@ModelAttribute("busDetails") BusData busData, Model model, UserLoginDTO user) {
//		String user = returnUsername();
		model.addAttribute("userDetails", user);
